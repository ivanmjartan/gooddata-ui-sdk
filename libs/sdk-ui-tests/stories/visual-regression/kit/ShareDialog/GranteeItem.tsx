...
storiesOf(`${UiKit}/ShareDialog/GranteeItem`, module).add(
    "full-featured",
    () => withMultipleScreenshots(<GranteeItemExamples />, {}), // Props TBD
);
storiesOf(`${UiKit}/ShareDialog/GranteeItem`, module).add(
    "themed",
    () => withMultipleScreenshots(wrapWithTheme(<GranteeItemExamples />), {}), // Props TBD
);
